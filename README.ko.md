...
>
> **내 환경 메모:** M2 Max (32GB)에서 사용 중. 32B 모델도 여유롭게 돌아감. 가상환경 없이 소스 설치했을 때 mlx 버전 충돌이 생긴 적 있어서 venv 강력 추천. `pip install -e ".[mcp]"` 로 설치하면 Claude Code 연동까지 한 번에 되니 처음부터 mcp 포함해서 설치하는 걸 권장.
